...
root = 'all_checkpoints/generalist/lightning_logs/version_0'
...
tokenizer = AutoTokenizer.from_pretrained('/mnt/vepfs/fs_users/lisihang/3D-MoLM/all_checkpoints/llama-2-7b-hf', use_fast=False, padding_side='right')
